...
이 명령은 현재 theme를 읽고 syntax, diagnostics, diff 샘플을 Webview로 엽니다. 샘플 영역을 클릭하면 클릭한 색상과 진단 맥락을 바탕으로 관련 개선 후보를 만들고, 생성 결과를 Webview의 improvement candidates panel에 표시하며 상태 알림도 보여줍니다.
